...
const Hero = () => {
  ...
  return (
    <section className="h-screen relative">
      <HeroHighlight className="flex lg:flex-row flex-col">
        <div className="lg:h-full h-1/2 flex flex-col lg:text-xl text-lg lg:gap-3 lg:pl-24 pt-12 px-5 mx-auto mt-10 lg:m-0 items-center justify-center lg:items-start text-center lg:text-start">
          ...
          <div className="mb-5 lg:mb-0">
            <p className="lg:text-xl" lang="en">
              I'm a new and <span className="underline">growing</span> developer
              with <span className="text-customBlue">marketing</span> and{" "}
          ...
          <p className="text-sm lg:text-base" lang="en">
            ...
            Javascript was... Now, I'm diving deep into in-demand frameworks and
            libraries like{" "}
          ...
          <p className="none text-sm lg:text-base" lang="ko">
            그냥 {studyTimeSpent()}개월전에는 제가 Javascript 하나도 몰랐는데...
            이제는 지금은{" "}
            <span className="text-2xl text-customBlue font-extrabold">
              React, Next.js, Chakra UI
            </span>{" "}
          ...
          <a href="#projects" className="pt-5">
            <button className="p-[3px] relative">
              ...
              <div
                lang="en"
                className="px-8 py-2 bg-black rounded-[6px] relative group transition duration-200 text-white hover:bg-transparent flex items-center gap-3"
              >
